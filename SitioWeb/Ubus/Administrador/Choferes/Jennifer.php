...
<nav class= "cuerpo2">
	<a href="http://jimenezlepe.comuv.com/Ubus/Administrador/Rutas/Ruta-142A.php"; class="cursor"><li class="item_l">Ruta 142A</li></a>
...
$consulta1= " SELECT * FROM Camion WHERE chofer='Jennifer' ";
$ejecutar_consulta1 =mysqli_query($conexion,$consulta1) or die ("No se pudo ejecutar la conexion a la BD");
$output='';

echo '<table border="1";class="item_l"><span class="derecha"><tr><th>Id Camion</th><th>Nombre Camion</th><th>Conductor</th><th>Capacidad </th></tr>';
