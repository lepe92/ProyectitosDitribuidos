			...
			$(data).find("marker").each(
					function() {
						...
						var html = "<b>Ubicacion "+marker
								...
								.attr("chofe");
						if(marker.attr("chofe")=="Inge Victor"){
...
<nav class= "cuerpo2">
	<a href="http://jimenezlepe.comuv.com/Ubus/Administrador/Rutas/Ruta-500.php"; class="cursor"><li class="item_l">Ruta 500</li></a>
...
$consulta1= " SELECT * FROM Camion WHERE chofer='Inge Victor' ";
