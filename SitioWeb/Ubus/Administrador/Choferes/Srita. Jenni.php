			...
			$(data).find("marker").each(
					function() {
						...
						var html = "<b>Ubicacion "+marker
								...
								.attr("chofe");
						if(marker.attr("chofe")=="Srita. Jenni"){
...
<nav class= "cuerpo2">
	<a href="http://jimenezlepe.comuv.com/Ubus/Administrador/Rutas/Ruta-602.php"; class="cursor"><li class="item_l">Ruta 602</li></a>
...
$consulta1= " SELECT * FROM Camion WHERE chofer='Srita. Jenni' ";
