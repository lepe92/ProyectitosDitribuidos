...
<nav class= "cuerpo2">
	<a href="http://jimenezlepe.comuv.com/Ubus/Administrador/Rutas/Ruta-396.php"; class="cursor"><li class="item_l">Ruta 396</li></a>
...
$consulta1= " SELECT * FROM Camion WHERE chofer='Tom' ";
